package com.example.lenovo.customviewdemo.clock_view;
...
public class ClockView extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    private void drawPointer(Canvas canvas) {
        ...
        double minute = calendar.get(Calendar.MINUTE) + second / 60;
        double hour = calendar.get(Calendar.HOUR) + minute / 60;
